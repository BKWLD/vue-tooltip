...
article
	...
	header
		h1 {{ page.title }}
		nav
			layout-logo(:logo='globals.logo')
			layout-nav(:links='globals.links')
...
import VueTooltip from '../../index.vue'
...
export default
	...
	asyncData: ({ app, params, $content }) ->
		...
		globals = await $content('globals').fetch()
...
p
	line-height 1.5
	color lighten(primary-background, 70%)
